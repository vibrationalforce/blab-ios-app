...
|---|-----------|----------------|---------------|------------|-------|
| A1 | **Piano Roll adaptiv + Pro-Funktionen** | „passt immer noch nicht…adaptiv" + „mehr Funktion… siehe Ableton… Echoel twist" (07-17) | Adaptiv v286 ✓, R1 Ops/Scale-Lock/Bio-Humanize v287 ✓ (b9e0973). R2-KERN ✓ (e126994, Gates laufen): `RollChordStamp` — kohärenz-gewählter, voice-geführter Akkord-Stempel (ChordSuggest H2 + VoiceLeader H1), rein/deterministisch, code-reviewer PASS + gehärtet. Nächste: R2-UI (Long-Press leere Zelle → stamp, im Gesten-Handler Bio lesen, EIN Undo-Schritt; Freeze-Gesetz) + Fold via RollRowMap | Founder stempelt Akkord per Long-Press; Bio-Humanize hörbar — **Gerät offen (R2-UI folgt)** | PLAN_ROLL_PRO.md |
