...
**Kein „nie".** Die großen Flächen sind die Zukunft als **AUSGABE** — externer Bildschirm/Beamer (#206), ADM-OSC-Raum —, nicht als zweite App-Oberfläche. Kommt iPad als Instrumenten-Fläche zurück, braucht es eine dort funktionierende Bio-Quelle (der BLE-Gurt ist gebaut und verdrahtet) plus den Adaptivitäts-Durchgang #292. **Der Durchgang passiert ohnehin:** iPhone allein spannt 375–440 pt, erlaubt Querformat und läuft mit ungedeckeltem Dynamic Type — heute reflowen **2 von 11** Panels bedingungslos: `mixerPanel` und `soundPanel` (letzteres mit sieben Gittern). Dazu **`moodPanel` bedingt** — es erbt sein Gitter über `weatherRow`, und das rendert seine Regler nur hinter `if weatherEnabled`, das per Default AUS ist. Die anderen acht — `menuPanelHost`, `bioPanel`, `videoPanel`, `tempoToolsPanel`, `sessionPanel`, `masterPanel`, `visualPanel`, `effectsPanel` — stapeln weiter starr.
...
**Und deshalb ist der Befehl unten seit #359 Schritt 1 aktiv irreführend, nicht bloß ungenau:** seine Regel „jede Gitter-Zeile gehört zur letzten Panel-Deklaration darüber" ordnet das `weatherRow`-Gitter weiterhin `sessionPanel` zu, weil `weatherRow` im File zwischen `sessionPanel` und `masterPanel` steht — während es seit #359 Schritt 1 in `moodPanel` rendert, 1600 Zeilen weiter unten. **Ein Gitter kann in einem `private var` liegen, das kein Panel ist**; wer nachführt, muss dem AUFRUFER folgen, nicht der Dateireihenfolge. Die dritte Zeile unten macht genau das —
```
...
Tests/EchoelmusicTests/ ← 313 test files (`git ls-files 'Tests/EchoelmusicTests/*.swift' | wc -l`,
                          ...
                          `Tests/CISmoke` (**113** Dateien, `git ls-files 'Tests/CISmoke/*.swift' | wc -l`,
                          2026-08-01 nach `ControlBoundaryIsInteractiveTests.swift` (#367),
                          ...
                          ungeprüft**. ZWEIUNDSIEBZIG FRÜHERE Stände in fünf Tagen — der aktuelle Wert 113 ist hier NICHT mitgezählt, anders als im Sources-Absatz oben (112·111·110·109·108·107·106·105·104·103·102·101·100·99·98·97·96·95·94·93·92·91·90·89·88·87·86·85·84·83·82·81·80·79·78·77·76·75·74·73·72·71·70·69·68·67·66·65·64·63·62·61·60·59·58·57·56·55·54·53·52·51·50·49·48·47·46·45·41·39·30·21 — bei der
