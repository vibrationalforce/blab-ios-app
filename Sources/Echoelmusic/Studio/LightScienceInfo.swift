...
public enum LightScienceTopic: String, CaseIterable, Identifiable, Sendable {
    ...
    public var detail: String {
        ...
        case .scope:
            return "Echoelmusic maps and explains light by real wavelength so your music and body can drive colour, visuals and DMX/Art-Net fixtures honestly. Tone colours use octave transposition — doubling a tone's frequency until it reaches the visible band — a concept popularized by the Swiss mathematician Hans Cousto (\u{201C}The Cosmic Octave\u{201D}, 1978); Echoelmusic computes it continuously from your actual tuning and renders the colour through the CIE 1931 colour-matching functions. The transposition is exact mathematics, and an artistic convention: sound and light are different physical phenomena, so no health or cosmic effect is implied. This is for creative expression and self-observation. It is NOT light therapy, makes no medical or wellness claim, diagnoses nothing, and treats no condition. If you are exploring light for health reasons, talk to a qualified clinician."
        }
    }
}
