...
Tests/EchoelmusicTests/ ← 313 test files (`git ls-files 'Tests/EchoelmusicTests/*.swift' | wc -l`,
                          ...
                          `Tests/CISmoke` (**186** Dateien, `git ls-files 'Tests/CISmoke/*.swift' | wc -l`,
                          2026-08-07 nach `RMSSDReadsOnlyAdjacentBeatsTests.swift` (#425 — der erste
