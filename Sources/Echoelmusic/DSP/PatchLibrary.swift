...
public enum PatchLibrary {
    ...
    public static let all: [LibraryPatch] = [
        ...
        LibraryPatch(SynthPatch(id: sid(3), name: "Aurora",
            ...
            spectralShape: "bright", filterCutoff: 3000, lfoToFilterDepth: 0.3,
            filterLFORate: 0.2, reverbMix: 0.45, reverbDecay: 4.5),
        ...
        LibraryPatch(SynthPatch(id: sid(42), name: "Deep Sub",
            ...
            harmonicity: 0.98, harmonicLevel: 0.9, brightness: 0.1,
            spectralShape: "dark", filterCutoff: 160, reverbMix: 0.05),
        ...
        LibraryPatch(SynthPatch(id: sid(52), name: "Cosmic Drift",
            ...
            spectralShape: "bright", filterCutoff: 2500, lfoToFilterDepth: 0.4,
            filterLFORate: 0.1, reverbMix: 0.5, reverbDecay: 6.5),
        ...
        LibraryPatch(SynthPatch(id: sid(58), name: "Wind Bed",
            ...
            lfoToFilterDepth: 0.3, filterLFORate: 0.15, reverbMix: 0.4),
        ...
        LibraryPatch(SynthPatch(id: sid(59), name: "Static Field",
            ...
            filterResonance: 0.3, lfoToFilterDepth: 0.4, filterLFORate: 0.4, reverbMix: 0.35),
