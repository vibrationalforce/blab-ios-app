...
Tests/EchoelmusicTests/ ← **314** test files (`git ls-files 'Tests/EchoelmusicTests/*.swift' | wc -l`,
                          ...
                          `Tests/CISmoke` (**231** Dateien, `git ls-files 'Tests/CISmoke/*.swift' | wc -l`,
                          2026-08-08 nach `TheBreathVoiceHasADoorTests.swift` (#277 — der erste Wächter dieser
...
**LIVE (4 — a producer derives each from the frame):** Coherence → **filter cutoff · brightness · harmonicity · noise level** | HRV → **brightness · reverb mix** | Heart rate → **vibrato depth AND rate · brightness** | Breath phase → **amplitude (the breath swell)**
