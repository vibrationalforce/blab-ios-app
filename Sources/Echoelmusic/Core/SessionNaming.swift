...
public enum SessionNaming {
    ...
    /// The descriptive stem, e.g. `Echoel_2026-06-12_Cm_124bpm_A440`.
    ...
    public static func stem(
        ...
        return [
            artistToken,
            dateStamp(date, calendar: calendar),
            keyToken,
            "\(trimmed(bpm))bpm",
            "A\(trimmed(a4Hz))"
        ].joined(separator: "_")
    ...
    public static func fileName(
        ...
        let base = stem(artist: artist, date: date, key: key, bpm: bpm, a4Hz: a4Hz, calendar: calendar)
