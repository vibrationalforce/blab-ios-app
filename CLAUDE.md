...
Tests/EchoelmusicTests/ ← 313 test files (`git ls-files 'Tests/EchoelmusicTests/*.swift' | wc -l`,
                          ...
                          `Tests/CISmoke` (**185** Dateien, `git ls-files 'Tests/CISmoke/*.swift' | wc -l`,
                          2026-08-07 nach `TheTransportBarIsDissolvedTests.swift` (#456 — der erste
