...
Tests/EchoelmusicTests/ ← 313 test files (`git ls-files 'Tests/EchoelmusicTests/*.swift' | wc -l`,
                          ...
                          2026-08-05 nach `ResetSoundClearsWhatTheLaunchLineReportsTests.swift` (#400 — der erste Wächter
