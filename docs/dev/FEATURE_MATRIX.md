...
- **Character params — LIVE (2026-06-17):** `MoodProfile` now 8 dims (… + **virtuosity, syncopation, humanize**), all consumed in the lead generator. **16 offered genres** (`MusicStyle.offered`; the enum holds more cases than are offered — nine older ones were curated out by ear on 2026-07-24 and re-offering them is a listening decision).
