...
Tests/EchoelmusicTests/ ← 313 test files (`git ls-files 'Tests/EchoelmusicTests/*.swift' | wc -l`,
                          2026-07-28). ⛔ Drei Zahlen kursierten für DIESE eine Suite: 305 hier,
                          294 in den Schrittnamen von `full-tests.yml`, 313 auf der Platte. Die
                          Workflow-Beschriftung ist founder-gated und bleibt vorerst falsch (#208).
                          Und die Suite ist NICHT das blockierende Bundle — das baut aus
                          `Tests/CISmoke` (1 Datei). Siehe KEY TESTS.
...
## KEY TESTS (313 files under `Tests/EchoelmusicTests/` — `git ls-files` 2026-07-28)
