...
Tests/EchoelmusicTests/ ← 313 test files (`git ls-files 'Tests/EchoelmusicTests/*.swift' | wc -l`,
                          ...
                          `Tests/CISmoke` (**146** Dateien, `git ls-files 'Tests/CISmoke/*.swift' | wc -l`,
                          2026-08-05 nach `ResetSoundClearsWhatTheLaunchLineReportsTests.swift` (#400 - der erste Waechter
                          in dieser Kette, der ein PAAR zusammenhaelt statt einer Sache: er liest die
                          `launch/musical:`-Zeile aus #401 und verlangt, dass jeder Wert, den der Reset
                          loescht, dort auch GEMELDET wird. Bewusst auf DIESE eine Zeile eingegrenzt und
                          nicht auf die Datei - die `generate[...]`-Breadcrumb traegt `key=`, `tuning=`
                          und `a4=` ebenfalls, ein dateiweiter Scan waere fuer genau die drei stumm
                          geblieben),
                          ...
                          ungeprüft**. HUNDERTFÜNF FRÜHERE Stände in acht Tagen (⛔ hier stand „sechs“, und die Zahl war nur mitgeschoben: der frühere Text sagte „fünf Tagen“ für 07-29…08-01, also VIER — der Off-by-one wurde beim Erhöhen geerbt statt geprüft. 07-29 bis 08-02 sind fünf; mit dem 08-05-Stand sind es acht, und dieser Absatz hat die Spanne diesmal MIT der Zahl nachgeführt statt sie stehen zu lassen) — der aktuelle Wert 145 ist hier NICHT mitgezählt, anders als im Sources-Absatz oben (145·144·143·142·141·140·139·138·137·136·135·134·133·132·131·130·129·128·127·126·125·124·123·122·121·120·119·118·117·116·115·114·113·112·111·110·109·108·107·106·105·104·103·102·101·100·99·98·97·96·95·94·93·92·91·90·89·88·87·86·85·84·83·82·81·80·79·78·77·76·75·74·73·72·71·70·69·68·67·66·65·64·63·62·61·60·59·58·57·56·55·54·53·52·51·50·49·48·47·46·45·41·39·30·21 — bei der
